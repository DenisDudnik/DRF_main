...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Project',
            fields=[
                ('uuid', models.UUIDField(default=uuid.UUID('6502baff-3e0c-4fc7-8e08-27f39c5d222b'), primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='TODO',
            fields=[
                ('uuid', models.UUIDField(default=uuid.UUID('a6abebc3-c7ab-4eaa-8c2c-c6d3e06268b7'), primary_key=True, serialize=False)),
